...
if (aboutUs) { // we are surely on home page
    ...
    const interSection = function (entries, observer) {
        ...
        if (entry.isIntersecting == true) {
            ...
            typewriter.typeString('Introducing <b class="companyDesriptionBrand">Feastwala</b> ,').changeDelay(2)
                .pauseFor(1000)
                ...
                .pauseFor(1000)
                .typeString('Enjoy your happy meal my friend with <b class="companyDesriptionBrand">Feastwala</b> 😊')
                .pauseFor(1000)
                .start();
    ...
    const interSectionMap = function (entries, observer) {
        ...
        if (entry.isIntersecting == true) {
            ...
            var map = new maplibregl.Map({
                ...
                style: 'https://api.maptiler.com/maps/streets-v2/style.json?key=yExgVD2w6i8h5kbsJEcM', // style of map
                scrollZoom: true 
            });
